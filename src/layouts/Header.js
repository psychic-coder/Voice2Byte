          ...
          <div className="col-lg-7" style={{ height: "100%" }}>
            <nav className="navbar" style={{ height: "100%" }}>
              <ul className="navbar-links" style={{ 
                ...
                <li className="navbar-dropdown" style={{ height: "100%", display: "flex", alignItems: "center" }}>
                  <Link href="/" style={{ padding: "10px 12px" }}>Home</Link>
                </li>
                <li className="navbar-dropdown" style={{ height: "100%", display: "flex", alignItems: "center" }}>
                  <Link href="about" style={{ padding: "10px 12px" }}>About</Link>
                </li>
                {currentUser?.user?.role === "HOTEL_ADMIN" && (
                  <>
                    <li className="navbar-dropdown" style={{ height: "100%", display: "flex", alignItems: "center" }}>
                      <Link href="/hotelAdmin/adminProfile" style={{ padding: "10px 12px" }}>AdminProfile</Link>
                    </li>
                    <li className="navbar-dropdown" style={{ height: "100%", display: "flex", alignItems: "center" }}>
                      <Link href="/hotelAdmin/foodItem" style={{ padding: "10px 12px" }}>FoodItems</Link>
                    </li>
                    <li className="navbar-dropdown" style={{ height: "100%", display: "flex", alignItems: "center" }}>
                      <Link href="/hotelAdmin/addFoodItem" style={{ padding: "10px 12px" }}>AddFoodItem</Link>
                    </li>
                    <li className="navbar-dropdown" style={{ height: "100%", display: "flex", alignItems: "center" }}>
                      <Link href="/hotelAdmin/orderStatus" style={{ padding: "10px 12px" }}>OrderStatus</Link>
                    </li>
                  </>
                ) }
                  <li className="navbar-dropdown" style={{ height: "100%", display: "flex", alignItems: "center" }}>
                    <Link href="restaurants" style={{ padding: "10px 12px" }}>Restaurants</Link>
                ...
                <li className="navbar-dropdown" style={{ height: "100%", display: "flex", alignItems: "center" }}>
                  <Link href="contacts" style={{ padding: "10px 12px" }}>Contacts</Link>
                </li>
              </ul>
            </nav>
          </div>
          <div className="col-lg-3" style={{ height: "100%" }}>
            <div className="extras bag d-flex align-items-center gap-2" style={{ 
              height: "100%",
              padding: "0 5px",
              ...
              {!currentUser?.user?.role === "HOTEL_ADMIN" && (
                <div className="button button-2 me-2" style={{ padding: "8px 12px" }}>
                  {currentUser ? (
                    <div
                      onClick={() =>
                        currentUser.user.role === "HOTEL_ADMIN"
