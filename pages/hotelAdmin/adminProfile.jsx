...
const AdminProfile = () => {
  ...
  const handleSignOut = async () => {
    ...
    try {
      console.log("Dispatching signOutSuccess");
              ...
              <div className="col-md-4 text-md-end mt-4 mt-md-0">
                <div className="d-flex align-items-center justify-content-end gap-2">
                  ...
                  <button
                    ...
                    className="btn btn-danger btn-sm rounded-pill px-3 d-flex align-items-center animate__animated animate__zoomIn animate__delay-1s"
                    style={{ zIndex: 1000, position: "relative" }} // Temporary debug styles
                  >
                ...
                <div className="card-body">
                  <div className="mb-4">
                    ...
                    <div className="d-flex align-items-center mb-2">
                      ...
                      <span>
                        {displayData.restaurantName || "Not specified"}
                      </span>
                    </div>
                    <div className="d-flex align-items-center mb-2">
